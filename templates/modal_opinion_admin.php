<!-- Modal pour le panel admin -->
<div class="modal fade" id="AdminOpinionModal" tabindex="-1" aria-labelledby="opinionModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="opinionForm" method="post" action="lib/create_opinion_admin.php">
          <div class="mb-3">
